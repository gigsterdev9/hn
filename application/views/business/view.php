		...
		<div class="panel-body">
            <div class="row">
                <div class="col-md-2 logo-div">
                    <img src="<?php echo base_url('/images/'.$biz['entity_logo_filename']) ?>" alt="placeholder_logo" class="company-logo" />
                </div>
                <div class="col-md-4">
                    <h4><?php echo $biz['entity_name']; ?></h4>
                    Executive: <?php echo $biz['entity_exec'] ?> <br />
                    Headquarters: <?php echo $biz['entity_hq'] ?> <br />
                    Website: <a href="<?php echo 'http'.$biz['entity_website'] ?>"><?php echo $biz['entity_website'] ?></a>
                </div>
                <div class="col-md-4">
