<div class="container">
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
            <div class="row">
                <div class="col-md-1">
                    <img src="<?php echo base_url('/images/denr-logo.jpg') ?>" alt="placeholder_logo" class="company-logo" />
                </div>
                <div class="col-md-5">
                    <h4>Department of Environment and Natural Resources</h4>
                    Parent Agency: N/A <br />
                    Executive: Gen. Roy Cimatu (ret) <br />
                    Headquarters: DENR Building, Visayas Avenue, Vasra, Quezon City <br />
                    Website: <a href="www.denr.gov.ph">www.denr.gov.ph</a>
                </div>
                <div class="col-md-4">
